...
const file_cluster_status_proto_rawDesc = "" +
	"\n" +
	"\x14cluster_status.proto\x12\x06status\"Q\n" +
	"\vStatusCheck\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x18\n" +
	"\apassing\x18\x02 \x01(\bR\apassing\x12\x14\n" +
	"\x05error\x18\x03 \x01(\tR\x05error\"\xcb\x03\n" +
	"\rClusterStatus\x12\x18\n" +
	"\aaccount\x18\x01 \x01(\tR\aaccount\x12\x16\n" +
	"\x06region\x18\x02 \x01(\tR\x06region\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12(\n" +
	"\x05state\x18\x04 \x01(\x0e2\x12.status.StatusTypeR\x05state\x12#\n" +
	"\rchart_version\x18\x05 \x01(\tR\fchartVersion\x12#\n" +
	"\ragent_version\x18\x06 \x01(\tR\fagentVersion\x12#\n" +
	"\rscrape_config\x18\a \x01(\tR\fscrapeConfig\x12+\n" +
	"\x11validator_version\x18\b \x01(\tR\x10validatorVersion\x12\x1f\n" +
	...
	"\tnamespace\x18\r \x01(\tR\tnamespace*\xb8\x01\n" +
	"\n" +
	"StatusType\x12\x1b\n" +
	"\x17STATUS_TYPE_UNSPECIFIED\x10\x00\x12\x1c\n" +
	"\x18STATUS_TYPE_INIT_STARTED\x10\x01\x12\x17\n" +
...
var (
	...
	file_cluster_status_proto_rawDescData []byte
)

func file_cluster_status_proto_rawDescGZIP() []byte {
	file_cluster_status_proto_rawDescOnce.Do(func() {
		file_cluster_status_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cluster_status_proto_rawDesc), len(file_cluster_status_proto_rawDesc)))
	})
...
func file_cluster_status_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cluster_status_proto_rawDesc), len(file_cluster_status_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
