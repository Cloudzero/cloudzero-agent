...
type ClusterConfig struct {
	...
	HelmlessOutputBase64      string                 `protobuf:"bytes,34,opt,name=helmless_output_base64,json=helmlessOutputBase64,proto3" json:"helmless_output_base64,omitempty"`
...
func (x *ClusterConfig) GetHelmlessOutputBase64() string {
	if x != nil {
		return x.HelmlessOutputBase64
	}
	return ""
}
...
const file_clusterconfig_proto_rawDesc = "" +
	"\n" +
	"\x13clusterconfig.proto\x12\x06status\"\x8b\x05\n" +
	...
	"\x18config_aggregator_base64\x18! \x01(\tR\x16configAggregatorBase64\x124\n" +
	"\x16helmless_output_base64\x18\" \x01(\tR\x14helmlessOutputBase64\x12\x16\n" +
